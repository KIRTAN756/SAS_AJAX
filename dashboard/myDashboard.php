...
<body>
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-5 text-white" href="#">SAS</a>
        <div class="d-flex align-items-center gap-2 px-2">
            <h5 class="offcanvas-title text-white" id="sidebarMenuLabel">Name</h5>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="overflow-y: auto; height: calc(100vh - 56px);">
                <div
                    class="d-flex justify-content-between flex-wrap flex-md-nowrap sticky-top shadow bg-body align-items-center pt-3 pb-2 mb-3 border-bottom">
